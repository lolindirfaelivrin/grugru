...
<body>
    ...
    <tr style='background-color:rgb(230,230,230);'><th style='width: 80px;'>Versione Php</th><td><?php echo phpversion() ?>
                </td>
            </tr>
            <tr style='background-color:rgb(230,230,230);'>
                <th style='width: 80px;'>Versione GruGru</th>
                <td>
                    <?php echo GruGru::$VERSIONE ?>
                </td>
            </tr>
            <tr style='background-color:rgb(230,230,230);'>
                <th style='width: 80px;'>Data & Ora</th>
                <td>
            ...
            <tr style='background-color:rgb(240,240,240);'>
                <th style='width: 80px;'>Messaggio errore</th>
                <td>
